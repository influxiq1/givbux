...
export class CampaignmanagementComponent implements OnInit {
  ...
  constructor(private cookeiservice: CookieService) {
    ...
    this.tabledatalis=[ //table
      ...
      {value:'image',name:'Image',role:0,func:'',class:'image',type:'image',foldername:'campaign'},
    ...
    this.formdata=[  //formvalue
      ...
      {inputtype:'image',name:'image',label:'Image',placeholder:'Select Image',buttonname:'Upload Campaign Image',validationrule:{required:true},validationerrormsg:'needs to save first , please click on save button first !',imagefolder:'campaign',aspectRatio:962/368,resizeToWidth:481},
